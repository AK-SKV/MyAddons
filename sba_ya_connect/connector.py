...
class YmkBinding(models.AbstractModel):
    ...
    _description = 'Ymk Binding (abstract)'
    ...
    # fields.Char because 0 is a valid YmkCommerce ID
    Ymk_id = fields.Char(string='ID on Ymk')

    _sql_constraints = [
        ('Ymk_uniq', 'unique(backend_id, Ymk_id)',
         'A binding already exists with the same Ymk ID.'),
    ]
